...
# ==================== Cross-validation ====================
#
# K-fold CV orkestratoru ve fold-bazli ozellik matrisi yardimcisi ayrı bir
# modulde tutulur (model/sl/cross_validation.py). Geriye donuk uyumluluk icin
# (hpo_xgb, train.py ve testler `training_runner` uzerinden import ediyor)
# burada yeniden disa actirilir.

from .cross_validation import (  # noqa: E402
    _SL_CV_METRIC_KEYS,
    _aggregate_sl_cv_metrics,
    _aggregate_sl_metric_dicts,
    _kfold_feature_matrix,
    run_sl_cv_training,
)
